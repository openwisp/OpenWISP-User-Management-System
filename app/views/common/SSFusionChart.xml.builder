...
xml.graph :caption => caption, :subcaption => subcaption, :numberSuffix => suffix, :showValues => show_values, :formatNumberScale => 0, :yAxisMinValue => (y_axis_min_value/1000)*1000, :decimalPrecision => decimal_precision, :showBorder => 1, :rotateNames => 1, :showNames => 1, :pieSliceDepth => 20, :pieYScale => 90, :numVDivLines => 22, :divLineAlpha => 80, :showAlternateHGridColor => 1, :AlternateHGridAlpha => 30, :AlternateHGridColor => 'CCCCCC' do
