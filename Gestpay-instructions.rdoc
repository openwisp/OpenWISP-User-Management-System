...
* *captive_portal_baseurl*: URL of the OWCPM (OpenWISP Captive Portal Manager) instance, which should be used with OWUMS
...
* *gestpay_vbv_url*: url of which users will be redirected to insert their credit card password; should be https://testecomm.sella.it/gestpay/pagamvisa3d.asp for the DEMO or https://ecomm.sella.it/gestpay/pagamvisa3d.asp for the real environment
...
Log in the Gestpay Backoffice, go to "Configurazione Cliente", then go to the page "NO DISPLAY". 
